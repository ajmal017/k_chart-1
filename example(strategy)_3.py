...
from BackTesting.backtesting import get_performance_1 as get_performance
...
from Strategy.strategy_m3 import get_shares
...
etf_tickers = ['SPY','XLB','XLE','XLF']
mc_budget = [0.7, 0.1, 0.1, 0.1] #
